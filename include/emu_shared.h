...
enum OAMFlag {
    OAM_PALLETE_CGB   = 0,  // **CGB Mode Only**     (OBP0-7)
    OAM_VRAM_BANK_CGB = 3,  // **CGB Mode Only**     (0=Bank 0, 1=Bank 1)
    OAM_PALLETE_DMG,        // **Non CGB Mode Only** (0=OBP0, 1=OBP1)
    OAM_X_FLIP,             // 0=Normal, 1=Horizontally mirrored
    OAM_Y_FLIP,             // 0=Normal, 1=Vertically mirrored
    OAM_BG_OVER_OBJ,        // 0=No, 1=BG and Window colors 1-3 over the OBJ
};
